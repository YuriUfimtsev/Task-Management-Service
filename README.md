# PostgreSQL в .NET
Файл *docs/Queries.md* содержит набор сложных запросов к PostgreSQL. Выполненные задания, указанные ниже, отображают реализацию взаимодействия с PostgreSQL из .NET проекта.
